...
@share_location.message(Command("share_location"))
...
# Cancellation option
@share_location.message(Command("cancel"), StateFilter(StatesLocation))
@share_location.message(F.text.casefold() == "cancel", StateFilter(StatesLocation))
...
@share_location.message(StatesLocation.GET_LOCATION, F.location)
...
@share_location.message(StatesLocation.GET_LOCATION)
